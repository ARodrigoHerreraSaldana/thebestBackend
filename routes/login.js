...
routerLogin.post("/", async (req, res) => {
  try {
    ...
    if (results.Result == 1) {
      ...
      res.cookie('accessToken', accessToken, { httpOnly: true, secure: true,  path: "/", sameSite: "none",  domain:'https://rodrigofrontend.it.com'     });
      res.cookie('refreshToken', refreshToken, { httpOnly: true, secure: true,  path: "/", sameSite: "none",domain:'https://rodrigofrontend.it.com' });
